...
async def test_user_auth_token_with_admin_api_key(async_client: AsyncClient, test_data: dict,
                                            mock_post, opt_scale_auth):
        mock_response = {
            "data" : {"token": "MDAwZWxvY2F0aW9uIAowMDM0aWRlbnRpZmllciBmMGJkMGM0YS03YzU1LTQ1YjctOGI1OC0y"  # noqa: E501
...
async def test_create_user_token(async_client: AsyncClient, test_data: dict,
                                            mock_post, opt_scale_auth):
        mock_response = {
            "data" : {"token": "MDAwZWxvY2F0aW9uIAowMDM0aWRlbnRpZmllciBmMGJkMGM0YS03YzU1LT"
        ...
        mock_post.return_value = mock_response
        user_token = await opt_scale_auth.obtain_auth_token_with_user_credentials(
            email="peter.parker@iamspiderman.com",
            password="With great power comes great responsibility",
        )
        mock_post.assert_called_once_with(
