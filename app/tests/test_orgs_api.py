...
class TestOptscaleOrgAPI:

    async def test_create_user_org(self, optscale_api, mock_post, mock_auth_token):
    ...
    async def test_get_user_org_empty_response(self, optscale_api, mock_get, mock_auth_token):
